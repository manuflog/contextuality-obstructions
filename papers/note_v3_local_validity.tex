...
holds exactly when $\alpha=2$. The general formulation --- one local system carrying
both the state-dependent $\U(1)$ layer and the state-independent torsion (AvN) layer
--- is open. (b) The
