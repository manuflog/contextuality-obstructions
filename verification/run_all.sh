...
for s in verify_cert8 verify_cert16 spectrum_test2 criterion Wformula close_T2_proof tmix_dindep arf_global thmG_general lueders_cp_interval lueders_instrument s4_povm_bayes; do
  tot=$((tot+1))
