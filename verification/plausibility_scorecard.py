...
ROWS = [
 ...
 ("S2 local classicality (MASA/Spec)",        15, 13, 15, "V23 DONE: every context trivializable, explicit lambda over mu_{4d} (half tau-steps needed), d=2,3,4; global contrast V10/V13/V33"),
 ...
 ("Copenhagen adequacy (observer/WF)",         15,  6, 14, "PAPER D v0.3: Thm4 FR LOCALIZED (V39: trivial class + hol=+1 invariant => conjecture self-refuted; state-sector CF=1/6 exact, facet=CHSH 7/3, ABM match); v0.2 pass #1 (Thm2 overclaim fixed w/ pinned counterexample; hol^2 invariance now PROVED; morphisms repaired): Thm1 relative facts (V23+V10+V38A pullback), Thm2 complementarity = gauge-robust Z2 holonomy hol^2 (V38B), Thm3 movable cut (V12 both levels + V37 forced update); pending adversarial pass + FR treatment. V12 HW-CONFIRMED (ibm_fez): loop +1, -i excluded ~56sig at ray level; PM 35.4sig over tight bound. "
